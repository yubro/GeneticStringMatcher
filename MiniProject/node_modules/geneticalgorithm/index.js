module.exports = function geneticAlgorithmConstructor(options) {
    ...
    return {
        ...
        //Added Functions to get the worst of the Population
        worst : function() {
            var scored = this.scoredPopulation()
            var result = scored.reduce(function(a,b){
                return a.score <= b.score ? a : b
        ...
        worstScore : function() {
            return settings.fitnessFunction( this.worst() );
        },
        population : function() {
        ...
        meanPopulation : function(){
            var average = 0;
            var scores = this.scoredPopulation();
            for(var i = 0;i < settings.population.length; i++){
                average+=scores[0]['score'];
            }
            //return average;
            return average / settings.population.length;
        },
        config : function() {
